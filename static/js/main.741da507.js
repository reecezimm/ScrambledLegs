...
`,Ed=xr.span`
  ...
  [data-status="in_progress"] &{ background: #6FCF97; box-shadow: 0 0 8px #6FCF97; animation-duration: 1.2s; }
  [data-status="beers"] &      { background: #FFB155; box-shadow: 0 0 8px #FFB155; animation-duration: 2s; }
`;function Cd(e,t){if("upcoming"===t){return Xi((e.start||0)-Date.now())||Ji.upcoming}return"in_progress"===t?`Riding \xb7 ${ea(Date.now()-e.start)}`:"beers"===t?"Beers being consumed":Ji[t]||t}const Td=xr.div`
  padding: 18px 18px 14px;
...
`,Xd=xr.div`
  ...
  `}
  ${e=>"out"===e.phase&&br`
    animation: ${Qd} 400ms ease-out forwards;
  `}
`,eu=xr.div`
  ...
  &[data-tier="all-time"] {
    ...
    -webkit-text-fill-color: transparent;
    animation: ${Jd} 1.2s linear infinite;
  }
`,tu=xr.div`
  margin-top: 10px;
...
`,lb=xr.div`
  ...
  top: ${e=>e.top||"50%"};
  left: ${e=>e.left||"50%"};
  animation: ${Qg} ${e=>e.duration||"20s"} ease-in-out infinite;
  animation-delay: ${e=>e.delay||"0s"};
  transform-origin: center;
...
//# sourceMappingURL=main.741da507.js.map